...
#5 clearing the screen
    screen.fill(0)
#6 drawing screen elements and background
...
#6.3.1 Attacking the castle
        ...
        if badrect.left<64:
            ...
            badguys.pop(index)
#6.3.2 Checking for the collisions
        index1=0
        for bullet in arrows:
...
#7 updating screen
    pygame.display.flip()
#8 for looping through the events
